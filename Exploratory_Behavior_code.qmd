...
normalize the pathways (fraction of visits are each pathways) before putting them in the model

binomial with the N being the number of female visits

```{r}
bf(spawns|trails(visits) ~ 1 + )

number of sneakers as a quadratic 
```
