...
f_visits_spawns <- behavior_sheet_sep |>
  ggplot(aes(`Total Female Visits`, `Total Spawns`)) +
  geom_point() +
  #Add a linear model line for visualization
...
f.tspawns.tvisits.mdl <- brm(data = behavior_sheet_cln,
      family = gaussian,
      total_spawns ~ total_female_visits,
      iter = 2000, warmup = 1000, chains = 4, cores = 4,
      seed = 4,
      file = 'output/f.tspawns.tvisits')

summary(f.tspawns.tvisits.mdl)
plot(f.tspawns.tvisits.mdl)
```
...
##### Female visits as a function of Nesting and Satellite aggression away from the nest

```{r}

```

##### Female spawns as a function of Nesting and Satellite aggression away from the nest
