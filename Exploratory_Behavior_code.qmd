...
fv.nm.court1 <-
  brm(data = behavior_sheet_cln, #Give the model the tibble
      ...
      iter = 2000, warmup = 1000, chains = 4, cores = 4, #Markov chain parameters
      seed = 4, #Determines which random numbers
      file = 'Exploratory model outputs/fv.nm.court2') #saves it as an output

summary(fv.nm.court1)
plot(fv.nm.court1)
```
...
fs.nm.court1 <-
  brm(data = behavior_sheet_cln, #Give the model the tibble
      ...
      iter = 2000, warmup = 1000, chains = 4, cores = 4, #Markov chain parameters
      seed = 4, #Determines which random numbers
      file = 'Exploratory model outputs/fs.nm.court1') #saves it as an output

summary(fs.nm.court1)
plot(fs.nm.court1)
```
...
Normalize the variables that we think are important, "female_visits_by_nm, female_visit_by_sat, female_visits_by_sat_passed_to_nm" by the total number of visits
