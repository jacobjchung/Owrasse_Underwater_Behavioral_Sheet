...
For comparisons between the male reproductive tactics, this code will add up the total and create a new column for each of the variables by male (i.e. Column for total amount of Female visits by SAT, Column for total amount of SAT only spawns).
