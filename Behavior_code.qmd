...
year_date <- as.character(yearly_totals$Year)
yearly_totals$Year <- year_date
```
...
avg_snk_years <- yearly_totals |>
  ggplot(aes(x = Year, y = avg_SNKR, fill = Year)) +
           geom_bar(stat = 'identity') + 
  scale_x_discrete(breaks = c(2017, 2018, 2019, 2022, 2023, 2024, 2025)) +
  labs(x = 'Year', 
