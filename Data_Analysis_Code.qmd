...
fv.avgsnkr1 <-
  brm(data = behavior_sheet_cln, #Give the model the tibble
      ...
      file = 'Exploratory model outputs/fv.avgsnkr1') #saves it as an output
...
fs.avgsnkr <-
  brm(data = behavior_sheet_cln, #Give the model the tibble
      ...
      iter = 2000, warmup = 1000, chains = 4, cores = 4, #Markov chain parameters
      seed = 4, #Determines which random numbers
      file = 'Exploratory model outputs/fs.avgsnkr') #saves it as an output
...
#### (Josh) Female visits as a function of nesting male courtship
...
#### (Josh) Female spawning as a function of nesting male courtship
...
#### (Josh) Female visits as a function of nesting male aggression
...
fvisits.nmagg.mdl1 <-
  brm(data = fvisits.nmagg, #Give the model the tibble
      ...
      iter = 2000, warmup = 1000, chains = 4, cores = 4, #Markov chain parameters
      seed = 4, #Determines which random numbers
      file = 'Exploratory model outputs/fvisits.nmagg.mdl1') #saves it as an output

print(fvisits.nmagg.mdl1, digits = 4)
plot(fvisits.nmagg.mdl1)
```

#### (Josh) Female spawning as a function of nesting male aggression
...
f.spawns.nmagg.mdl1 <-
  brm(data = f.spawns.nmagg, #Give the model the tibble
      ...
      iter = 2000, warmup = 1000, chains = 4, cores = 4, #Markov chain parameters
      seed = 4, #Determines which random numbers
      file = 'Exploratory model outputs/f.visits.nmagg.mdl1') #saves it as an output
